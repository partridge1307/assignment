...
import { BookTag, bookSchema, uploadBook } from "@/api/books";
...
const UploadAuthorForm = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Success",
        description: "Book uploaded, Redirecting to homepage...",
      });
...
export default UploadAuthorForm;
